export const homeObjOne = {
    ...
    description: 'Get acess ti our exclusive app that allows you to send unlimited transactions without getting charged any fess.',
...
export const homeObjThree = {
    ...
    imgStart: false,
    img: require('./../../images/payments.svg'),
    alt: 'Payments',
    dark: true,
    primary: true,
    darkText: false
